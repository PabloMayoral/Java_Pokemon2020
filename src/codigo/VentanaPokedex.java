...
//En caso de no poner IO se transforma en una exception generico con errores gerenicos
    ...
    private void initComponents() {
        ...
        getContentPane().add(imagenPokemon, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 210, 110));

        jTextPane1.setEditable(false);
        jTextPane1.setBackground(new java.awt.Color(0, 0, 0));
        jTextPane1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jTextPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 160, 220, 50));
        ...
        getContentPane().add(peso, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 270, 90, 20));

        altura.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(altura, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 270, 90, 20));

        tipo1.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(tipo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 120, 100, 40));

        tipo2.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(tipo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, 100, 40));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pokedex.png"))); // NOI18N
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 610, 320));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (p != null) {
            ...
            tipo1.setText(" Tipo: " +p.tipo1);
            tipo2.setText(" Tipo: " +p.tipo2);
            ...
            jTextPane1.setText("NO HAY DATOS");
        }
        contador--;
        if (contador <= 0) {
            contador = 0;
